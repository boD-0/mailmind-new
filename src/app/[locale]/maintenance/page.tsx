      ...
      <div className="relative w-full max-w-4xl mx-auto px-4">
        ...
        >
          ...
          >
            <a
              href={`/${l}/login`}
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full bg-copper text-white font-semibold hover:bg-copper/80 transition-all duration-200 shadow-lg shadow-copper/20 active:scale-[0.98]"
            >
