    ...
    <AppShell>
      <div className="min-h-[80vh] flex items-center justify-center">
        <div className="glass-deep p-10 rounded-2xl border border-white/5 w-full max-w-md">
          <h2 className="font-display text-3xl mb-6 text-copper text-center">Join MailMind</h2>
          <form className="space-y-6">
            <div>
              <label className="text-[10px] tracking-widest text-cream/40 uppercase font-bold">Full Name</label>
              <input type="text" className="w-full mt-2 bg-white/5 border border-white/10 rounded-lg px-4 py-3 outline-none focus:border-copper transition-colors" />
            </div>
            <div>
              <label className="text-[10px] tracking-widest text-cream/40 uppercase font-bold">Work Email</label>
