    ...
    >
      ...
      <div id="poda" className="relative flex items-center justify-center group">
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[65px] max-w-[312px] rounded-xl blur-[3px] 
                        ...
                        before:bg-[conic-gradient(rgba(0,0,0,0),#18116a,rgba(0,0,0,0)*10%,rgba(0,0,0,0)*50%,#6e1b60,rgba(0,0,0,0)_60%)] before:transition-all before:duration-2000
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[63px] max-w-[307px] rounded-lg blur-[2px] 
                        ...
                        before:bg-[conic-gradient(rgba(0,0,0,0)*0%,#a099d8,rgba(0,0,0,0)*8%,rgba(0,0,0,0)*50%,#dfa2da,rgba(0,0,0,0)*58%)] before:brightness-140
        ...
        <div id="main" className="relative group">
          ...
          {value && (
            <button
              ...
              className="absolute top-1/2 -translate-y-1/2 right-[92px] flex items-center justify-center w-5 h-5 rounded-full bg-white/10 hover:bg-white/20 transition-all text-gray-400 hover:text-white z-10"
          ...
          <div className="absolute top-1/2 -translate-y-1/2 right-[52px] pointer-events-none select-none">
            <kbd className="flex items-center gap-0.5 rounded-md bg-white/10 px-2 py-0.5 text-[10px] font-mono text-gray-400 backdrop-blur-sm border border-white/5">
          ...
          <div className="absolute h-[42px] w-[40px] overflow-hidden top-[7px] right-[7px] rounded-lg
                          ...
                          before:bg-[conic-gradient(rgba(0,0,0,0),#3d3a4f,rgba(0,0,0,0)*50%,rgba(0,0,0,0)*50%,#3d3a4f,rgba(0,0,0,0)_100%)]
                          before:brightness-135 before:animate-spin-slow">
          </div>
          <div id="filter-icon" className="absolute top-2 right-2 flex items-center justify-center z-[2] max-h-10 max-w-[38px] h-full w-full [isolation:isolate] overflow-hidden rounded-lg bg-gradient-to-b from-[#161329] via-black to-[#1d1b4b] border border-transparent pointer-events-none">
