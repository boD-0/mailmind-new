      ...
      >
        <div className="relative">
          <motion.div
            ...
            className="absolute -inset-4 rounded-full border-2 border-dashed border-copper/20"
          />
          <div className="w-16 h-16 bg-copper rounded-2xl flex items-center justify-center shadow-lg shadow-copper/20">
        ...
        >
          <span className="inline-flex items-center gap-1.5 bg-copper/10 text-copper text-xs font-semibold tracking-wider px-4 py-1.5 rounded-full mb-4">
            <Sparkles size={12} />
